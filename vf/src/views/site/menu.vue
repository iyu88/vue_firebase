    ...
    <div>
        ...
        <v-list>
            ...
            >
                ...
                <v-list-item v-if="$store.state.editable" @click="openDialogSubItem(i, -1)">
        ...
        <v-dialog v-model="dialogItem" max-width="400">
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-text-field v-model="formItem.title" label="아이템 이름" outlined clearable hide-details></v-text-field>
                </v-card-text>
            </v-card>
            <v-dialog v-model="dialogSubItem" max-width="400">
                <v-card>
                    ...
                    <v-card-text>
                        <v-text-field v-model="formSubItem.title" placeholder="메뉴 이름" outlined required></v-text-field>
                        <v-text-field v-model="formSubItem.to" placeholder="경로" outlined required></v-text-field>
                    </v-card-text>
                </v-card>
            </v-dialog>
        </v-dialog>
...
export default {
  ...
  methods: {
    ...
    moveItem (item, index, arrow) {
      item.splice(index + arrow, 0, ...item.splice(index, 1))
      this.save()
    },
